 ...
 * @author lianp
 */
public class CriarTarefa1 extends javax.swing.JFrame {

    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(CriarTarefa1.class.getName());
    ...
    public CriarTarefa1(InicioTarefas telaTarefas, Usuario usuario
    ...
    public CriarTarefa1(InicioTarefas telaTarefas, int linha, String titulo, String descricao, String materia, String prioridade, String dataEntrega) {
        initComponents();
        this.telaTarefas = telaTarefas;
